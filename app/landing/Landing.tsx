...
export const Landing = () => {
  ...
  return (
    ...
    >
      <article
        className={`flex items-center justify-center bg-gradient-to-t from-nav-bg-start/[.25] to-nav-bg-end/[.25] backdrop-blur-md rounded-3xl text-white border border-gray-400 border-opacity-10 shadow-xl ${
